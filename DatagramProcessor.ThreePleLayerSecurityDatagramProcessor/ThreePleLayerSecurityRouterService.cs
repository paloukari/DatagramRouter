...
namespace Corp.RouterService.Message.RouterService
{
    ...
    public class ThreePleLayerSecurityRouterService : RouterService
    {
        private global::Corp.RouterService.Message.MessageRoutingTable _routingTable;

        public ThreePleLayerSecurityRouterService(global::Corp.RouterService.Message.MessageRoutingTable routingTable)
        {
